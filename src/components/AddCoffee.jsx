...
const AddCoffee = () => {
    ...
    const handleAddCoffee = event => {
        ...
        fetch('https://my-coffee-store-server-gold.vercel.app/coffee', {
            method: 'POST',
            headers: {
    ...
    return (
        <div className='w-full min-h-dvh form-bg p-20'>
            <div className='w-5/6 mx-auto p-10 bg-ash-100 rounded-xl'>
                <h2 className='font-rancho text-5xl text-black font-bold text-center mb-10'>Add a Coffee</h2>
